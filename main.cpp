...
void UserTicket()
{
    ...
    cout << endl;
    cout << "Showing Ticket of " << input << endl
         << endl;
    if (!qstate)
    {
        res = mysql_store_result(conn);
...
void DisplayPassenger()
{
    ...
    cout << "Welcome To Airlines Reservation System" << endl
         << endl;
    cout << "Display Passenger Menu" << endl
         << endl;
